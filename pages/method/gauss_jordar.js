...
import { JordanMethod } from "../../utils/api";
  ...
  const submitHandler = async (e) => {
    ...
    try {
      if (validation()) {
        ...
        let res = await JordanMethod(data);
        if (res.error) {
          ...
          <div className="row ">
            ...
            <div className="col-md-5 img-div ">
              ...
              <p style={{ wordSpacing: "1px" }}>
                The Gauss Jordan Elimination, or Gaussian Elimination, is an
                algorithm to solve a system of linear equations by representing
                it as an augmented matrix, reducing it using row operations, and
                expressing the system in reduced row-echelon form to find the
