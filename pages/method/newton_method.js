...
import { BisectionMethod, EliminationMethod, NewtonsMethod } from '../../utils/api';
            ...
            <div className="row">
              <h5>
                <strong>Equation</strong>
                  ...
                  <TextField id="standard-basic" label="Equation" variant="filled"    placeholder="x^2+sin(x)+1"
                    value={equation}
                    type="text"
